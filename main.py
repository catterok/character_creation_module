...
def attack(char_name: str, char_class: str) -> str:
    """Функция attack отвечает за атаку противника, то есть нанесённый урон."""
...
def special(char_name: str, char_class: str) -> str:
    """Функция special отвечает за применение специальных умений класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция start_training отвечает за проведение тренировочного боя."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция choice_char_class отвечает за выбор класса и его описания."""
    approve_choice: str = ''
    char_class: str = ''
